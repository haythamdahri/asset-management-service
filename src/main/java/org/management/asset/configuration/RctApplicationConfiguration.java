    ...
    public void runApplication() throws IOException {
        try {
            ...
            if (this.userService.getUsers().isEmpty()) {
                ...
                AssetFile avatar = new AssetFile("Database.png", "png", MediaType.IMAGE_PNG_VALUE, FileUtils.readFileToByteArray(new File(Constants.USER_DEFAULT_IMAGE)), LocalDateTime.now(), LocalDateTime.now());
